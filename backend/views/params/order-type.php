        ...
        <div class="col-md-7">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">所有订单类型</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table no-margin data-grid data-grid-check" data-form="ordertype">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Code</th>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?= $form->field($model, 'code')->input('text', ['maxlength' => '128', 'placeholder' => '订单类型编码']) ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?= $form->field($model, 'name')->input('text', ['maxlength' => '128', 'placeholder' => '订单类型']) ?>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer">
                    ...
                    <button type="button" onclick="window.admin.params.orderType.save()" class="btn btn-info pull-right">提交
                    </button>
                </div>
                <!-- /.box-footer -->
                <?php ActiveForm::end(); ?>
