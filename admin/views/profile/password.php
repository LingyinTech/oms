        ...
        <div class="col-md-8">
            <div class="box box-info">
                ...
                <div class="box-footer">
                    ...
                    <button type="button" onclick="window.admin.profile.password()" class="btn btn-info pull-right">提交</button>
                </div>
                <!-- /.box-footer -->
                <?php ActiveForm::end(); ?>
            </div>
...
$this->registerJsFile(Url::to('@web/static/admin/js/profile.js'), ['depends' => 'dmstr\web\AdminLteAsset']);
?>