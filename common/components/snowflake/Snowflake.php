...
class Snowflake extends Component
{
    ...
    /**
     * @var int 机器Id,合法值 0~31
     */
    protected $workerId;

    /**
     * @var int 数据中心ID,合法值 0~31
     */
    ...
    public function getStartTimeStamp()
    {
        ...
        $defaultTime = '2020-08-08 08:08:08';
    ...
    {
        $maxDataCenterId = -1 ^ (-1 << self::MAX_DATACENTER_LENGTH);
        if ($maxDataCenterId < 0 || $dataCenterId > $maxDataCenterId) {
            throw new InvalidConfigException("dataCenterId 值不合法，可选值范围【0-{$maxDataCenterId}】");
        }
